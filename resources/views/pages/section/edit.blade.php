<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Section &raquo; {{ $section->name }} &raquo; Edit
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div>
                ...
                <form action="{{ route('dashboard.section.update', $section->id) }}" class="w-full" method="POST"
                    ...
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-full px-3 mb-6">
                            ...
                            <input value="{{ old('name') ?? $section->name }}" name="name"
                        ...
                        <div class="w-full px-3 mb-6">
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Name
                                Section
                                <span class="text-red-500">*</span></label>
                            <input value="{{ old('description') ?? $section->description }}" name="description"
                                class="appearance-none block w-full lg:w-1/2 bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                type="text">
                        </div>
                        ...
                        <div class="w-full px-3 mb-6">
                            ...
                            <select name="is_active"
                                class="appearance-none block w-full lg:w-1/2 bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                                <option value="{{ $section->is_active }}" selected>
                                ...
                                <option disabled>--- select is active ---</option>
                        ...
                        <div class="w-full px-3 mb-6">
                            ...
                            <textarea name="details"
                                class="appearance-none block w-full lg:w-1/2 bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                cols="30" rows="5">{{ old('details') ?? $section->details }}</textarea>
                        </div>
